...
const { getPublishedQuizzes, addQuiz, publishQuiz, updateQuiz, deleteQuiz, getUserQuizzes, getQuizById, getQuizByPermalink, getQuizResult } = require("../../controllers/quiz.js")
...
quizRouter.put("/get_quiz_result/:quiz_id", getQuizResult);
